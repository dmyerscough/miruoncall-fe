      ...
      <CardHeader>
        ...
        <CardDescription>
          <span className="hidden @[540px]/card:block">
            A total of <span className=" font-semibold">{chartData.incidents.length}</span> {chartData.incidents.length > 1 ? `alerts` : `alert`} were triggered during this time period.
          </span>
